...
function Service2details({ route, navigation }) {
...
const allServices = {
  1: {
    '5km': [{ name: 'Harry\'s Plumbing', work: 'Plumber', distance: '1.05km', review: '2.0' }],
    '10km': [{ name: 'Freddie\'s Plumbing', work: 'Plumber', distance: '7km', review: '3.0' }],
    '15km': [{ name: 'Jade\'s Plumbing Service', work: 'Plumber', distance: '12km', review: '1.0' }],
    '20km': [{ name: 'Will\'s Plumbing Works', work: 'Plumber', distance: '17km', review: '4.0' }],
  },
  2: {
    '5km': [{ name: 'Harry\'s Appliance Service', work: 'Appliance Repair', distance: '1.05km', review: '2.0' }],
    '10km': [{ name: 'Justin\'s Appliance Fix', work: 'Appliance Repair', distance: '6km', review: '3.0' }],
    '15km': [{ name: 'Alan\'s Appliance Repairs', work: 'Appliance Repair', distance: '13km', review: '4.0' }],
    '20km': [{ name: 'Cooling Appliance Solutions', work: 'Appliance Repair', distance: '16km', review: '1.0' }],
  },
  3: {
    '5km': [{ name: 'Jake\'s AC Repair', work: 'AC Repair', distance: '2.5km', review: '3.0' }],
    '10km': [{ name: 'Tommy\'s AC Service', work: 'AC Repair', distance: '8km', review: '4.0' }],
    '15km': [{ name: 'Lisa\'s AC Experts', work: 'AC Repair', distance: '14km', review: '2.0' }],
    '20km': [{ name: 'Mark\'s AC Works', work: 'AC Repair', distance: '18km', review: '5.0' }],
  },
  4: {
    '5km': [{ name: 'Mona\'s Pest Control', work: 'Pest Control', distance: '3km', review: '4.0' }],
    '10km': [{ name: 'Chris\' Pest Solutions', work: 'Pest Control', distance: '6km', review: '3.0' }],
    '15km': [{ name: 'Sharon\'s Pest Experts', work: 'Pest Control', distance: '12km', review: '5.0' }],
    '20km': [{ name: 'Gary\'s Pest Control Works', work: 'Pest Control', distance: '19km', review: '4.0' }],
  },
  5: {
    '5km': [{ name: 'Liam\'s Carpentry', work: 'Carpenter', distance: '4.0km', review: '4.0' }],
    '10km': [{ name: 'Sara\'s Carpentry Services', work: 'Carpenter', distance: '9km', review: '3.0' }],
    '15km': [{ name: 'John\'s Carpentry Works', work: 'Carpenter', distance: '14km', review: '4.0' }],
    '20km': [{ name: 'Peter\'s Carpentry', work: 'Carpenter', distance: '19km', review: '5.0' }],
  },
  6: {
    '5km': [{ name: 'Noah\'s Electrical Service', work: 'Electrician', distance: '2.5km', review: '4.0' }],
    '10km': [{ name: 'Max Electrical Repairs', work: 'Electrician', distance: '5.5km', review: '3.0' }],
    '15km': [{ name: 'Eva\'s Electrical Experts', work: 'Electrician', distance: '13km', review: '2.0' }],
    '20km': [{ name: 'Alex\'s Electrical Works', work: 'Electrician', distance: '17km', review: '4.0' }],
  },
  7: {
    '5km': [{ name: 'Olivia\'s Painting', work: 'Paint', distance: '1.5km', review: '5.0' }],
    '10km': [{ name: 'Ben\'s Painting Services', work: 'Paint', distance: '6km', review: '4.0' }],
    '15km': [{ name: 'Zoe\'s Paint Experts', work: 'Paint', distance: '10km', review: '4.0' }],
    '20km': [{ name: 'Charlie\'s Painting Works', work: 'Paint', distance: '18km', review: '4.0' }],
  },
};
