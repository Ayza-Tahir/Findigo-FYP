...
function Service5details({ route, navigation }) {
  ...
  const allServices = {
  1: {
    '5km': [{ name: 'City Hospital', work: 'Hospitals', distance: '2.0km', review: '4.0' }],
    '10km': [{ name: 'Greenfield Hospital', work: 'Hospitals', distance: '7km', review: '3.0' }],
    '15km': [{ name: 'Riverside Hospital', work: 'Hospitals', distance: '12km', review: '4.0' }],
    '20km': [{ name: 'Parkview Hospital', work: 'Hospitals', distance: '15km', review: '4.0' }],
  },
  2: {
    '5km': [{ name: 'Best Pharmacy', work: 'Pharmacies', distance: '1.5km', review: '4.0' }],
    '10km': [{ name: 'City Pharmacy', work: 'Pharmacies', distance: '6km', review: '4.0' }],
    '15km': [{ name: 'Hilltop Pharmacy', work: 'Pharmacies', distance: '13km', review: '3.0' }],
    '20km': [{ name: 'Cure Pharmacy', work: 'Pharmacies', distance: '18km', review: '4.0' }],
  },
  3: {
    '5km': [{ name: 'Alpha Lab', work: 'Labs', distance: '2.5km', review: '4.0' }],
    '10km': [{ name: 'City Lab', work: 'Labs', distance: '8km', review: '3.0' }],
    '15km': [{ name: 'Health Lab', work: 'Labs', distance: '14km', review: '4.0' }],
    '20km': [{ name: 'Bio Lab', work: 'Labs', distance: '18km', review: '4.0' }],
  },
  4: {
    '5km': [{ name: 'Green Clinic', work: 'Clinics', distance: '3km', review: '4.0' }],
    '10km': [{ name: 'Sunshine Clinic', work: 'Clinics', distance: '7km', review: '1.0' }],
    '15km': [{ name: 'Park Clinic', work: 'Clinics', distance: '13km', review: '3.0' }],
    '20km': [{ name: 'Hilltop Clinic', work: 'Clinics', distance: '17km', review: '4.0' }],
  },
  5: {
    '5km': [{ name: 'Smile Dental', work: 'Dentists', distance: '1.2km', review: '4.0' }],
    '10km': [{ name: 'City Dental', work: 'Dentists', distance: '5km', review: '1.0' }],
    '15km': [{ name: 'Bright Smiles', work: 'Dentists', distance: '12km', review: '4.0' }],
    '20km': [{ name: 'Healthy Teeth', work: 'Dentists', distance: '16km', review: '2.0' }],
  },
  6: {
    '5km': [{ name: 'MindCare', work: 'Psychologist', distance: '3km', review: '1.0' }],
    '10km': [{ name: 'Peace Clinic', work: 'Psychologist', distance: '7km', review: '2.0' }],
    '15km': [{ name: 'Clear Mind', work: 'Psychologist', distance: '10km', review: '4.0' }],
    '20km': [{ name: 'Therapy Center', work: 'Psychologist', distance: '15km', review: '3.0' }],
  },
  7: {
    '5km': [{ name: 'MoveWell Therapy', work: 'Physical Therapy', distance: '2.5km', review: '4.0' }],
    '10km': [{ name: 'Vital Therapy', work: 'Physical Therapy', distance: '6km', review: '4.0' }],
    '15km': [{ name: 'Total Therapy', work: 'Physical Therapy', distance: '11km', review: '4.0' }],
    '20km': [{ name: 'Flex Therapy', work: 'Physical Therapy', distance: '18km', review: '4.0' }],
  },
};
