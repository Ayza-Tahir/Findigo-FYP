...
import loc from '../../assets/HealthCare.png';
...
function Service5({ route,navigation }) {
...
const services = [
    ...
    { id: 3, name: 'Laboratory', icon: Service5c },
 ...
 useEffect(() => {
  ...
  return (
    <View style={styles.containerAS}>
      ...
      <Text style={styles.textAS}>Health Care Services</Text>
...
<ScrollView contentContainerStyle={styles.scrollContainer} showsVerticalScrollIndicator={false}>
        <View style={styles.gridContainer}>
          {services.map((service) => (
            ...
            onTouchEnd={() =>
                navigation.navigate('Service5details', {
                   id:service.id,
                  name: service.name,
                  icon: service.icon,
                })
